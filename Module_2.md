...
> **Важно**: Для импорта пользователей из users.csv нужно использовать скрипт, в интернете я не нашел скриптов которые были переносили все дополнительные флаги для пользователей которые указаны в /opt/users.csv, поэтому я написал свой собственный скрипт, его можно найти [тут](https://github.com/meowehh/samba-import).
